<div class="bg-white rounded-lg shadow-xl pb-8">
    <div x-data="{ openSettings: false }" class="absolute right-12 mt-4 rounded">
        ...
        <div x-show="openSettings" x-cloak @click.away="openSettings = false"
...
<div class="my-4 flex flex-col 2xl:flex-row space-y-4 2xl:space-y-0 2xl:space-x-4">
        ...
        <div class="flex-1 bg-white rounded-lg shadow-xl mt-4 p-8">
            ...
            <div class="relative px-4">
                ...
                <div class="flex items-center w-full my-6 -ml-1.5">
                    ...
                    <div class="w-11/12">
                        <p class="text-sm">New order received <a href="#" class="text-primary font-bold">#OR9653</a>.
                        </p>
    ...
    <div class="flex flex-col w-full 2xl:w-2/3">
        <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
            ...
            <p class="mt-2 text-gray-700">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt voluptates
        ...
        <div class="flex-1 bg-white rounded-lg shadow-xl mt-4 p-8">
            ...
            <div class="mt-4">
                <canvas id="verticalBarChart"
                    style="display: block; box-sizing: border-box; height: 442px; width: 884px;" width="1768"
                    height="884"></canvas>
            </div>
        </div>
    </div>
...
<div class="bg-white rounded-lg shadow-xl p-8">
    ...
    <div
        ...
        <a href="#" class="flex flex-col items-center justify-center text-gray-800 hover:text-primary"
            title="View Profile">
